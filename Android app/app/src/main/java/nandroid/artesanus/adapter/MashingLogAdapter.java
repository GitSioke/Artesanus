 ...
 */
public class MashingLogAdapter extends ArrayAdapter<Event> implements View.OnClickListener
{
    private static String PACKAGE_NAME;
    private static ArrayList<Event> dataSet;
    Context mContext;

    public MashingLogAdapter(ArrayList<Event> data, Context context)
    {
