...
{    
  ...
  switch (currentStatus)
  {
    ...
    case STOP:
      Serial.println("Stopping boiling process");
      currentStatus = NOTSTARTED;
      break;
  }
...
///
/// This funtion send data collected to server when there is a boiling process in progress
///
